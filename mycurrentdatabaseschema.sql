...
--
-- Name: generate_proposal_slug(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.generate_proposal_slug() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION public.generate_proposal_slug() OWNER TO postgres;
...
CREATE TABLE public.ai_generations (
    ...
    user_feedback text,
    created_at timestamp with time zone DEFAULT now(),
    CONSTRAINT ai_generations_generation_type_check CHECK ((generation_type = ANY (ARRAY['proposal_content'::text, 'pricing_suggestion'::text, 'timeline_estimate'::text, 'translation'::text, 'optimization'::text])))
);
...
CREATE TABLE public.email_logs (
    ...
    CONSTRAINT email_logs_status_check CHECK ((status = ANY (ARRAY['sent'::text, 'delivered'::text, 'bounced'::text, 'failed'::text])))
);
...
CREATE TABLE public.integration_sync_logs (
    ...
    CONSTRAINT integration_sync_logs_status_check CHECK ((status = ANY (ARRAY['success'::text, 'error'::text, 'partial'::text])))
);
...
CREATE TABLE public.integrations (
    ...
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now(),
    CONSTRAINT integrations_platform_check CHECK ((platform = ANY (ARRAY['notion'::text, 'airtable'::text, 'trello'::text, 'asana'::text, 'pipedrive'::text, 'hubspot'::text, 'zapier'::text])))
);
...
CREATE TABLE public.notifications (
    ...
    CONSTRAINT notifications_type_check CHECK ((type = ANY (ARRAY['proposal_viewed'::text, 'proposal_signed'::text, 'payment_received'::text, 'trial_ending'::text, 'system_update'::text])))
);
...
--
-- Name: proposal_analytics; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.proposal_analytics (
    ...
    CONSTRAINT proposal_analytics_event_type_check CHECK ((event_type = ANY (ARRAY['view'::text, 'scroll'::text, 'click'::text, 'download'::text, 'signature_start'::text, 'signature_complete'::text, 'exit'::text])))
);


ALTER TABLE public.proposal_analytics OWNER TO postgres;

--
-- Name: proposal_analytics_summary; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.proposal_analytics_summary OWNER TO postgres;
...
CREATE TABLE public.proposals (
    ...
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now(),
    CONSTRAINT proposals_language_check CHECK ((language = ANY (ARRAY['en'::text, 'uk'::text, 'ru'::text, 'pl'::text, 'de'::text, 'es'::text, 'pt'::text]))),
...
CREATE TABLE public.subscriptions (
    ...
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now(),
    CONSTRAINT subscriptions_status_check CHECK ((status = ANY (ARRAY['active'::text, 'canceled'::text, 'past_due'::text, 'paused'::text, 'trialing'::text]))),
    CONSTRAINT subscriptions_tier_check CHECK ((tier = ANY (ARRAY['starter'::text, 'pro'::text, 'agency'::text])))
);
...
CREATE TABLE public.usage_tracking (
    ...
    created_at timestamp with time zone DEFAULT now(),
    CONSTRAINT usage_tracking_resource_type_check CHECK ((resource_type = ANY (ARRAY['proposals'::text, 'ai_generations'::text, 'exports'::text, 'analytics_views'::text])))
);
...
CREATE TABLE public.users (
    ...
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now(),
    CONSTRAINT users_locale_check CHECK ((locale = ANY (ARRAY['en'::text, 'uk'::text, 'ru'::text, 'pl'::text, 'de'::text, 'es'::text, 'pt'::text]))),
    CONSTRAINT users_subscription_tier_check CHECK ((subscription_tier = ANY (ARRAY['free'::text, 'starter'::text, 'pro'::text, 'agency'::text])))
);
...
--
-- Name: proposal_analytics proposal_analytics_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: proposal_analytics_summary proposal_analytics_summary_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.proposal_analytics_summary
    ADD CONSTRAINT proposal_analytics_summary_pkey PRIMARY KEY (proposal_id);
...
--
-- Name: proposal_versions proposal_versions_proposal_id_version_number_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: proposals proposals_public_url_slug_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.proposals
    ADD CONSTRAINT proposals_public_url_slug_key UNIQUE (public_url_slug);


--
-- Name: subscriptions subscriptions_paddle_subscription_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: usage_tracking usage_tracking_user_id_resource_type_period_start_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.usage_tracking
    ADD CONSTRAINT usage_tracking_user_id_resource_type_period_start_key UNIQUE (user_id, resource_type, period_start);
...
CREATE INDEX idx_analytics_event_type ON public.proposal_analytics USING btree (event_type, "timestamp" DESC);


--
-- Name: idx_analytics_proposal_timestamp; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_analytics_proposal_timestamp ON public.proposal_analytics USING btree (proposal_id, "timestamp" DESC);


--
-- Name: idx_integrations_user_platform; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_integrations_user_platform ON public.integrations USING btree (user_id, platform);
...
--
-- Name: idx_proposals_public_url; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_proposals_public_url ON public.proposals USING btree (public_url_slug);
...
--
-- Name: idx_proposals_user_status; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_users_locale; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: proposals generate_proposal_slug_trigger; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER generate_proposal_slug_trigger BEFORE INSERT ON public.proposals FOR EACH ROW EXECUTE FUNCTION public.generate_proposal_slug();
...
--
-- Name: ai_configurations ai_configurations_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ai_configurations
    ADD CONSTRAINT ai_configurations_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspaces(id) ON DELETE CASCADE;


--
-- Name: ai_generations ai_generations_proposal_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ai_generations
    ADD CONSTRAINT ai_generations_proposal_id_fkey FOREIGN KEY (proposal_id) REFERENCES public.proposals(id) ON DELETE CASCADE;
...
--
-- Name: assets assets_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: integration_sync_logs integration_sync_logs_integration_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: proposal_analytics proposal_analytics_proposal_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.proposal_analytics
    ADD CONSTRAINT proposal_analytics_proposal_id_fkey FOREIGN KEY (proposal_id) REFERENCES public.proposals(id) ON DELETE CASCADE;


--
-- Name: proposal_analytics_summary proposal_analytics_summary_proposal_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.proposal_analytics_summary
    ADD CONSTRAINT proposal_analytics_summary_proposal_id_fkey FOREIGN KEY (proposal_id) REFERENCES public.proposals(id) ON DELETE CASCADE;


--
-- Name: proposal_templates proposal_templates_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.proposal_templates
    ADD CONSTRAINT proposal_templates_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id);


--
-- Name: proposal_templates proposal_templates_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.proposal_templates
    ADD CONSTRAINT proposal_templates_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspaces(id);


--
-- Name: proposal_versions proposal_versions_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.proposal_versions
    ADD CONSTRAINT proposal_versions_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id);
...
--
-- Name: proposals Public proposals viewable by all; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Public proposals viewable by all" ON public.proposals FOR SELECT USING (((public_url_slug IS NOT NULL) AND (status = ANY (ARRAY['sent'::text, 'viewed'::text]))));
...
--
-- Name: proposals Users can view own proposals; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can view own proposals" ON public.proposals FOR SELECT USING (((created_by = auth.uid()) OR (EXISTS ( SELECT 1
...
--
-- Name: proposal_analytics; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION generate_proposal_slug(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.generate_proposal_slug() TO anon;
GRANT ALL ON FUNCTION public.generate_proposal_slug() TO authenticated;
GRANT ALL ON FUNCTION public.generate_proposal_slug() TO service_role;
...
--
-- Name: TABLE ai_configurations; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE proposal_analytics; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.proposal_analytics TO anon;
GRANT ALL ON TABLE public.proposal_analytics TO authenticated;
GRANT ALL ON TABLE public.proposal_analytics TO service_role;


--
-- Name: TABLE proposal_analytics_summary; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.proposal_analytics_summary TO anon;
GRANT ALL ON TABLE public.proposal_analytics_summary TO authenticated;
GRANT ALL ON TABLE public.proposal_analytics_summary TO service_role;


--
-- Name: TABLE proposal_templates; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE proposal_versions; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE user_templates; Type: ACL; Schema: public; Owner: postgres
--
